...
// Debug: Log directory structure before processing
...
const requiredFiles = [
    path.join(SRC_DIR, 'templates', 'base.html'),
    path.join(SRC_DIR, 'content', 'pages', 'index.md'),
...
// Add this function after processMarkdown
function generateBlogIndex() {
    ...
    return posts; // Return posts for use in homepage
}

// Add this to the end of the build script, before 'Build complete!'
